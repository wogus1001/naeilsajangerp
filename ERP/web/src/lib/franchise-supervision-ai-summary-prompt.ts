    ...
    return [
        {
            ...
            content: [
                ...
                '발화 출처는 evidence에 남긴다. memo에는 "점주 의견 기준", "직원 진술 기준" 같은 출처 접두어를 항목마다 반복하지 않는다.',
                '각 memo는 항목별 판정 근거와 후속 조치가 드러나도록 2~3문장으로 정리한다.',
                '각 memo에는 가능한 범위에서 "현상", "운영상 영향", "후속 조치"를 포함한다.',
        ...
        },
        {
            ...
            content: [
                ...
                '- 각 항목 memo는 "현상 + 운영 영향 + 필요한 조치" 순서로 작성한다.',
                ...
                '  "inspectionItems": [',
                '    { "id": "점검 항목 ID", "label": "점검 항목명", "result": "양호|주의|개선필요", "memo": "현상, 영향, 후속 조치를 포함한 항목별 기록", "evidence": "원문 근거 요약 또는 짧은 인용" }',
                '  ]',
                '}',
                '',
                '[현장 메모]',
