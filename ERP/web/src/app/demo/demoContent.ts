...
export const DEMO_SCENARIOS = {
    manager: {
        ...
        tourSteps: [
            ...
            { id: 'manager-5', screen: 'leadDb', targetId: 'lead-detail-disclosure', targetSelector: '[role="dialog"][aria-labelledby="franchise-lead-detail-title"] section[aria-label="가맹 희망자 정보공개서"]', title: '정보공개서와 14일 기준 확인', description: '승격된 고객에게 보낼 문서와 수신 정보를 확인합니다. 발송 기록일 기준 14일 전에는 표준 계약 전환을 서버에서 제한하며, 이메일 열람 표시는 법적 수령 확인을 대신하지 않습니다.' },
    ...
    admin: {
        ...
        tourSteps: [
            ...
            { id: 'admin-5', screen: 'leadDb', targetId: 'lead-detail-disclosure', targetSelector: '[role="dialog"][aria-labelledby="franchise-lead-detail-title"] section[aria-label="가맹 희망자 정보공개서"]', title: '정보공개서와 14일 기준 확인', description: '승격된 고객의 정보공개서 발송 기록과 계약 가능 시점을 확인합니다. 표준 계약 전환은 14일 기준을 서버에서 확인하며 체크리스트는 회사의 법률 검토를 대신하지 않습니다.' },
