...
alter table public.realty_import_jobs
  alter column company_id drop not null;

alter table public.external_property_listings
  alter column company_id drop not null,
...
drop policy if exists "Company members can view realty_import_jobs" on public.realty_import_jobs;
drop policy if exists "Requesters can view own realty_import_jobs" on public.realty_import_jobs;
drop policy if exists "Company members can insert realty_import_jobs" on public.realty_import_jobs;
drop policy if exists "Requesters can insert own realty_import_jobs" on public.realty_import_jobs;
drop policy if exists "Company members can update realty_import_jobs" on public.realty_import_jobs;
drop policy if exists "Requesters can update own realty_import_jobs" on public.realty_import_jobs;
drop policy if exists "Company members can delete realty_import_jobs" on public.realty_import_jobs;
drop policy if exists "Requesters can delete own realty_import_jobs" on public.realty_import_jobs;

drop policy if exists "Company members can view external_property_listings" on public.external_property_listings;
drop policy if exists "Requesters can view own external_property_listings" on public.external_property_listings;
drop policy if exists "Company members can insert external_property_listings" on public.external_property_listings;
drop policy if exists "Requesters can insert own external_property_listings" on public.external_property_listings;
drop policy if exists "Company members can update external_property_listings" on public.external_property_listings;
drop policy if exists "Requesters can update own external_property_listings" on public.external_property_listings;
drop policy if exists "Company members can delete external_property_listings" on public.external_property_listings;
drop policy if exists "Requesters can delete own external_property_listings" on public.external_property_listings;
