...
values
  ('signup_request', '회원가입 승인 요청', 'submitted', false, '[프랜차이즈 본부 ERP] 회원가입 승인 요청 안내\n\n#{회사명} #{신청자명}님이 #{가입유형} 가입을 요청했습니다.\n요청일: #{요청일}\n\n관리자 화면에서 승인 여부를 확인해 주세요.', '["회사명","신청자명","가입유형","요청일"]'::jsonb, '프랜차이즈 본부 ERP 회원가입 승인 요청 안내용 알림톡입니다. 회사 구성원이 가입을 요청한 경우 관리자 또는 팀장에게 승인 처리를 안내하기 위해 발송되는 정보성 메시지입니다. 광고성 내용은 포함하지 않습니다.'),
  ('signup_approved', '회원가입 승인 완료', 'submitted', false, '[프랜차이즈 본부 ERP] 회원가입 승인 완료\n\n#{신청자명}님, #{회사명} 계정 승인이 완료되었습니다.\n이제 프랜차이즈 본부 ERP에 로그인해 서비스를 이용할 수 있습니다.', '["회사명","신청자명"]'::jsonb, '프랜차이즈 본부 ERP 회원가입 승인 완료 안내용 알림톡입니다. 회사 관리자가 가입 요청을 승인한 경우 신청자에게 계정 사용 가능 상태를 안내하기 위해 발송되는 정보성 메시지입니다. 광고성 내용은 포함하지 않습니다.'),
  ('disclosure_email_sent', '정보공개서 이메일 발송 안내', 'submitted', false, '[프랜차이즈 본부 ERP] 정보공개서 확인 안내\n\n#{후보자명}님, #{브랜드명} 정보공개서가 이메일로 발송되었습니다.\n가맹계약 전 필수 확인 문서이므로 이메일을 확인해 주세요.\n정보공개서 수령 확인일을 기준으로 법정 숙고기간이 계산됩니다.\n\n확인 후 수령 확인을 진행해 주세요.', '["후보자명","브랜드명"]'::jsonb, '프랜차이즈 본부 ERP 정보공개서 이메일 발송 안내용 알림톡입니다. 가맹 희망자에게 정보공개서가 이메일로 발송되었음을 안내하고, 수령 확인을 요청하기 위해 발송되는 정보성 메시지입니다. 광고성 내용은 포함하지 않습니다.'),
  ('disclosure_confirmed', '정보공개서 수령 확인 완료', 'submitted', false, '[프랜차이즈 본부 ERP] 정보공개서 수령 확인 완료\n\n#{후보자명}님이 #{브랜드명} 정보공개서 수령 확인을 완료했습니다.\n확인일: #{확인일}\n\n후속 계약 가능일과 체크 항목을 확인해 주세요.', '["후보자명","브랜드명","확인일"]'::jsonb, '프랜차이즈 본부 ERP 정보공개서 수령 확인 완료 안내용 알림톡입니다. 가맹 희망자가 이메일로 발송된 정보공개서의 수령 확인을 완료한 경우, 담당자 또는 팀장에게 후속 계약 진행 상태 확인을 안내하기 위해 발송되는 정보성 메시지입니다. 광고성 내용은 포함하지 않습니다.'),
  ('franchise_contract_eligible', '가맹계약 가능일 도래', 'submitted', false, '[프랜차이즈 본부 ERP] 가맹계약 가능 상태 안내\n\n#{후보자명}님의 정보공개서 숙고기간이 종료되어 가맹계약 진행이 가능합니다.\n계약 가능일: #{계약가능일}\n\n계약 전 확인 항목을 점검해 주세요.', '["후보자명","계약가능일"]'::jsonb, '프랜차이즈 본부 ERP 가맹계약 가능 상태 안내용 알림톡입니다. 정보공개서 수령 확인 후 법정 숙고기간이 종료된 경우, 담당자 또는 팀장에게 가맹계약 진행 가능 상태와 후속 확인 업무를 안내하기 위해 발송되는 정보성 메시지입니다. 광고성 내용은 포함하지 않습니다.'),
  ('vendor_contract_due', '업체계약 만료 안내', 'submitted', false, '[프랜차이즈 본부 ERP] 업체 계약 만료 안내\n\n#{업체명} #{계약명}의 만료일이 다가왔습니다.\n만료일: #{만료일}\n남은 기간: #{남은기간}\n\n갱신, 종료, 보관 여부를 확인해 주세요.', '["업체명","계약명","만료일","남은기간"]'::jsonb, '프랜차이즈 본부 ERP 업체 계약 만료 안내용 알림톡입니다. 회사에서 등록한 외부 업체 계약의 만료일이 다가온 경우, 계약 담당자 또는 팀장에게 갱신, 종료, 보관 여부 확인을 안내하기 위해 발송되는 정보성 메시지입니다. 광고성 내용은 포함하지 않습니다.')
