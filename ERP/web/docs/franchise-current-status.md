...
- 최신 운영 배포 기준 커밋: `e4fe6e7 chore(deploy): ignore local artifacts in vercel uploads` (`dpl_CEyXPQ2hVy5PnifeFkUMpcesxLLN`, `https://www.fcerp.co.kr` READY). 이번 배포 후보는 모객 DB/고객/명함/점포개발 화면의 세션 auth header 보강과 Node.js 24.x 전환 설정을 포함한다.
