...
- 최신 운영 배포 기준 커밋: `0508a58 fix(auth): send session headers from service screens` (`dpl_FomWQRRrrEn61UvAQFYA4mYria4e`, `https://www.fcerp.co.kr` READY). 모객 DB/고객/명함/점포개발 화면의 세션 auth header 보강과 Node.js 24.x 전환 설정을 포함한다.
